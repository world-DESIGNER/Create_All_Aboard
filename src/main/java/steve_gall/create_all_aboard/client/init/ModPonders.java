package steve_gall.create_all_aboard.client.init;
...
{
	public static final PonderTag ASSEMBLING_TRAIN_TAG = new PonderTag(new ResourceLocation(CreateAllAboard.MOD_ID, "assembling_train"))//
	...
	public static final PonderRegistrationHelper PONDERS = new PonderRegistrationHelper(CreateAllAboard.MOD_ID);
