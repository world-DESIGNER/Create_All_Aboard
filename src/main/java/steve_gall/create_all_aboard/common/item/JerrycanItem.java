...
import steve_gall.create_all_aboard.common.mixin.contraption.PortableStorageInterfaceBlockEntityAccessor;
import steve_gall.create_all_aboard.common.util.NumberHelper;

public class JerrycanItem extends Item
{
	public static String TOOLTIP_FILLED = CreateAllAboard.translationKey("tooltip", "filled");
	public static String TOOLTIP_DRAINED = CreateAllAboard.translationKey("tooltip", "drained");
	public static String TOOLTIP_ITEM_EMPTY = CreateAllAboard.translationKey("tooltip", "item_empty");
	public static String TOOLTIP_ITEM_FULL = CreateAllAboard.translationKey("tooltip", "item_full");
	public static String TOOLTIP_STORAGE_EMPTY = CreateAllAboard.translationKey("tooltip", "storage_empty");
	public static String TOOLTIP_STORAGE_FULL = CreateAllAboard.translationKey("tooltip", "storage_full");
