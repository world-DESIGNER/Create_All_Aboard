...
import static steve_gall.create_trainwrecked.client.init.ModPonders.OUT_LINE_SHOW_TIME;
import static steve_gall.create_trainwrecked.client.init.ModPonders.SECTION_FADING_TIME;
import static steve_gall.create_trainwrecked.client.init.ModPonders.TEXT_IDLE_TIME;
import static steve_gall.create_trainwrecked.client.init.ModPonders.TEXT_SHOW_TIME;
import static steve_gall.create_trainwrecked.client.init.ModPonders.createAssemblingTrainStory;
...
import steve_gall.create_trainwrecked.client.ponder.instruction.InfinityTrackInstruction;
import steve_gall.create_trainwrecked.client.ponder.instruction.PonderBogeyManagerInstruction;
